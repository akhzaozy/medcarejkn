...
async function runImport() {
  ...
  try {
    ...
    // Ensure UNAVAILABLE demo cases (CASE-0033 to CASE-0036) are present for safety guardrail demonstration
    await client.query(`
      INSERT INTO cases (case_id, claim_id, primary_risk_mode, review_priority, case_status, affected_items, evidence_gap, evidence_coverage_pct, review_focus, data_status)
      VALUES 
      ('CASE-0033', 'CLM-0033', 'UNAVAILABLE_EVIDENCE', 'NO_CONCLUSION', 'OPEN', 'CI-0033-1, CI-0033-2', 10, 0, 'Service record unavailable. Guardrail active: cannot conclude fraud without documentation.', 'SYNTHETIC'),
      ('CASE-0034', 'CLM-0034', 'UNAVAILABLE_EVIDENCE', 'NO_CONCLUSION', 'OPEN', 'CI-0034-1, CI-0034-2', 10, 0, 'Service record unavailable. Guardrail active: cannot conclude fraud without documentation.', 'SYNTHETIC'),
      ('CASE-0035', 'CLM-0035', 'UNAVAILABLE_EVIDENCE', 'NO_CONCLUSION', 'OPEN', 'CI-0035-1, CI-0035-2', 10, 0, 'Service record unavailable. Guardrail active: cannot conclude fraud without documentation.', 'SYNTHETIC'),
      ('CASE-0036', 'CLM-0036', 'UNAVAILABLE_EVIDENCE', 'NO_CONCLUSION', 'OPEN', 'CI-0036-1, CI-0036-2', 10, 0, 'Service record unavailable. Guardrail active: cannot conclude fraud without documentation.', 'SYNTHETIC')
